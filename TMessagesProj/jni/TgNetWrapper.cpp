...
static const char *FileLoadOperationClassPathName = "org/ملو گرام/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/ملو گرام/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/ملو گرام/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/ملو گرام/tgnet/RequestDelegateInternal;Lorg/ملو گرام/tgnet/QuickAckDelegate;Lorg/ملو گرام/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/ملو گرام/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ملو گرام/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ملو گرام/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ملو گرام/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/ملو گرام/tgnet/ConnectionsManager"));
