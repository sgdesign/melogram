...
import org.ملو گرام.ui.Components.RoundVideoPlayingDrawable;
import org.ملو گرام.ui.Components.SeekBar;
import org.ملو گرام.ui.Components.SeekBarWaveform;
import org.ملو گرام.ui.Components.StaticLayoutEx;
...
import org.ملو گرام.ui.PhotoViewer;
import org.ملو گرام.ui.SecretMediaViewer;
    ...
    public void setMessageObject(MessageObject messageObject, boolean bottomNear, boolean topNear) {
        ...
        if (messageChanged || dataChanged || isPhotoDataChanged(messageObject) || pinnedBottom != bottomNear || pinnedTop != topNear) {
            ...
            if (messageObject.type == 0) {
                ...
                if (!drawInstantView) {
                    if ("ملو گرام_channel".equals(webpageType)) {
                        drawInstantView = true;
                        drawInstantViewType = 1;
                    } else if ("ملو گرام_group".equals(webpageType)) {
                        drawInstantView = true;
