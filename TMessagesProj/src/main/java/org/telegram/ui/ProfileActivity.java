...
import org.ملو گرام.ui.Cells.AboutLinkCell;
import org.ملو گرام.ui.Cells.DividerCell;
import org.ملو گرام.ui.Cells.EmptyCell;
import org.ملو گرام.ui.Cells.LoadingCell;
import org.ملو گرام.ui.Cells.ShadowSectionCell;
import org.ملو گرام.ui.Cells.TextCell;
import org.ملو گرام.ui.Cells.TextDetailCell;
import org.ملو گرام.ui.Cells.TextInfoPrivacyCell;
import org.ملو گرام.ui.Cells.UserCell;
...
import org.ملو گرام.ui.Components.IdenticonDrawable;
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow || position == channelNameRow) {
            ...
            if (MessagesController.getInstance().callsEnabled && userFull != null && userFull.phone_calls_available) {
                items.add(LocaleController.getString("CallViaملو گرام", R.string.CallViaملو گرام));
                actions.add(2);
            }
