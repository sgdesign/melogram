...
import org.meloogram.messenger.ImageLoader;
...
import org.meloogram.messenger.NativeCrashManager;
...
import org.meloogram.messenger.camera.CameraController;
...
import org.ملو گرام.ui.Adapters.DrawerLayoutAdapter;
import org.ملو گرام.ui.ActionBar.ActionBarLayout;
import org.ملو گرام.ui.ActionBar.BaseFragment;
import org.ملو گرام.ui.ActionBar.DrawerLayoutContainer;
import org.ملو گرام.ui.Cells.LanguageCell;
import org.ملو گرام.ui.Components.EmbedBottomSheet;
import org.ملو گرام.ui.Components.JoinGroupAlert;
import org.ملو گرام.ui.Components.LayoutHelper;
import org.ملو گرام.ui.Components.PasscodeView;
...
import org.ملو گرام.ui.Components.ThemeEditorView;
        ...
        sideMenu.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(final View view, int position) {
                ...
                if (position == 0) {
                    ...
                    Browser.openUrl(LaunchActivity.this, LocaleController.getString("ملو گرامFaqUrl", R.string.ملو گرامFaqUrl));
                    drawerLayoutContainer.closeDrawer(false);
                } else if (id == 10) {
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                        ...
                        if (data != null) {
                            ...
                            if (scheme != null) {
                                if ((scheme.equals("http") || scheme.equals("https"))) {
                                    ...
                                    if (host.equals("ملو گرام.me") || host.equals("t.me") || host.equals("ملو گرام.dog") || host.equals("telesco.pe")) {
                                    ...
                                    if (url.startsWith("tg:resolve") || url.startsWith("tg://resolve")) {
                                        url = url.replace("tg:resolve", "tg://ملو گرام.org").replace("tg://resolve", "tg://ملو گرام.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:join", "tg://ملو گرام.org").replace("tg://join", "tg://ملو گرام.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://ملو گرام.org").replace("tg://addstickers", "tg://ملو گرام.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://ملو گرام.org").replace("tg://msg", "tg://ملو گرام.org").replace("tg://share", "tg://ملو گرام.org").replace("tg:share", "tg://ملو گرام.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                    ...
                    } else if (intent.getAction().equals("org.meloogram.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
