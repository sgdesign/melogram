...
import org.ملو گرام.tgnet.SerializedData;
...
import org.ملو گرام.ui.Cells.TextInfoCell;
import org.ملو گرام.ui.Cells.EmptyCell;
import org.ملو گرام.ui.Cells.HeaderCell;
import org.ملو گرام.ui.Cells.ShadowSectionCell;
import org.ملو گرام.ui.Cells.TextCheckCell;
import org.ملو گرام.ui.Cells.TextDetailSettingsCell;
import org.ملو گرام.ui.Cells.TextSettingsCell;
...
import org.ملو گرام.ui.Components.AvatarDrawable;
import org.ملو گرام.ui.Components.AvatarUpdater;
...
import org.ملو گرام.ui.Components.NumberPicker;
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                if (position == textSizeRow) {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showDialog(builder.create());
                } else if (position == ملو گرامFaqRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("ملو گرامFaqUrl", R.string.ملو گرامFaqUrl));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.getString("ملو گرامFAQ", R.string.ملو گرامFaq), true);
                    } else if (position == contactsReimportRow) {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == textSizeRow || position == enableAnimationsRow || position == notificationRow || position == backgroundRow || position == numberRow ||
                    ...
                    position == switchBackendButtonRow || position == ملو گرامFaqRow || position == contactsSortRow || position == contactsReimportRow || position == saveToGalleryRow ||
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(LocaleController.formatString("ملو گرامVersion", R.string.ملو گرامVersion, String.format(Locale.US, "v%s (%d) %s", pInfo.versionName, code, abi)));
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                    break;
